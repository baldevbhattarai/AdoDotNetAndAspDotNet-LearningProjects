<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WizardControl.aspx.cs" Inherits="ControllsDemo.WizardControl" %>
    ...
    <form id="form1" runat="server">
        <div aria-orientation="vertical">
            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" OnFinishButtonClick="Wizard1_FinishButtonClick" OnNextButtonClick="Wizard1_NextButtonClick">
                <SideBarStyle BackColor="#CCFF99" VerticalAlign="Top" />
                <WizardSteps>
